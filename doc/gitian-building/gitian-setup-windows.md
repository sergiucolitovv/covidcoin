...
The build script we'll be using is contained in the COVID19 github repository ([contrib/gitian-build.py](https://github.com/covid19-project/covid19/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the COVID19 repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/COVID19-Project/COVID19/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, covid19-detached-sigs, and covid19 GitHub repos.
