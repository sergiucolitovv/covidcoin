...
UniValue blockToJSON(const CBlock& block, const CBlockIndex* blockindex, bool txDetails = false)
{
    ...
    UniValue zcov19Obj(UniValue::VOBJ);
    for (auto denom : libzerocoin::zerocoinDenomList) {
        zcov19Obj.push_back(Pair(std::to_string(denom), ValueFromAmount(blockindex->mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    zcov19Obj.push_back(Pair("total", ValueFromAmount(blockindex->GetZerocoinSupply())));
    result.push_back(Pair("zCOV19supply", zcov19Obj));
    ...
    if (block.IsProofOfStake()) {
        ...
        stakeData.push_back(Pair("stakeModifierHeight", ((stake->IsZCOV19()) ? "Not available" : std::to_string(
...
UniValue getchecksumblock(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw std::runtime_error(
            ...
            "  \"zCOV19supply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zCOV19 denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zCOV19 denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zCOV19 denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zCOV19 denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zCOV19 denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zCOV19 denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zCOV19 denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zCOV19 denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zCOV19 denominations\n"
            "  }\n"
            "}\n"
...
UniValue getaccumulatorwitness(const UniValue& params, bool fHelp)
{
    ...
    if (!GenerateAccumulatorWitness(pubCoin, accumulator, witness, nMintsAdded, strFailReason)) {
        receipt.SetStatus(_(strFailReason.c_str()), ZCOV19_FAILED_ACCUMULATOR_INITIALIZATION);
