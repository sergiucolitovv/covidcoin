...
extern UniValue DoZcov19Spend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, std::vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzcov19seed(const UniValue& params, bool fHelp);
extern UniValue getzcov19seed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzcov19(const UniValue& params, bool fHelp);
extern UniValue dzcov19state(const UniValue& params, bool fHelp);
