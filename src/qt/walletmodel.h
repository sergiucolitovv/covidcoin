...
#ifndef COVID19_QT_WALLETMODEL_H
#define COVID19_QT_WALLETMODEL_H
...
/** Interface to COVID19 wallet from Qt view code. */
...
#endif // COVID19_QT_WALLETMODEL_H
