                                                        ...
                                                        model(0)
{
    ...
    ui->labelTitle->setText("Select COV19 Denominations to Spend");
...
void CoinControlDialog::updateLabels(WalletModel* model, QDialog* dialog)
{
    ...
    int nDisplayUnit = BitcoinUnits::COV19;
    ...
    QString toolTip4 = tr("Can vary +/- %1 ucov19 per input.").arg(dFeeVary);
