                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzCOV19PathCustom = GetArg("-zcov19backuppath", "");
    ...
    if(!strzCOV19PathCustom.empty()) {
        ui->wallet_customzcov19backuppath->setText(QString::fromStdString(strzCOV19PathCustom));
        ui->wallet_customzcov19backuppath_label->setVisible(true);
        ui->wallet_customzcov19backuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzCOV19PathCustom.empty()) && nCustomBackupThreshold > 0) {
