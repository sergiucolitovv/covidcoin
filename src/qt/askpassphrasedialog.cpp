...
#include "qt/covid19/loadingdialog.h"
...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        bool ret = openStandardDialog(
                ...
                tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR COV19</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
                tr("ENCRYPT"), tr("CANCEL")
        );
        if (ret) {
            if (newpass1 == newpass2) {
                newpassCache = newpass1;
                COVID19GUI* window = static_cast<COVID19GUI*>(parentWidget());
...
{
    COVID19GUI* gui = static_cast<COVID19GUI*>(parentWidget());
...
{
    hide();
    static_cast<COVID19GUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("COVID19 will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your COV19s from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
