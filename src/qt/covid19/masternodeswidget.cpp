...
#include "qt/covid19/forms/ui_masternodeswidget.h"
#include "qt/covid19/qtutils.h"
#include "qt/covid19/mnrow.h"
#include "qt/covid19/mninfodialog.h"

#include "qt/covid19/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(COVID19GUI *parent) :
    PWidget(parent),
...
void MasterNodesWidget::onCreateMNClicked(){
    if(verifyWalletUnlocked()) {
        if(walletModel->getBalance() <= (COIN * 10000)){
            inform(tr("Not enough balance to create a masternode, 10,000 COV19 required."));
            return;
        }
        showHideOp(true);
