...
#include "qt/covid19/coincontrolcov19widget.h"
#include "qt/covid19/forms/ui_coincontrolcov19widget.h"

CoinControlCov19Widget::CoinControlCov19Widget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlCov19Widget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select COV19 Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("COV19");
    ...
    ui->labelValueAfter->setText("0.00 COV19");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 COV19");
    ui->labelValueFee->setText("0.00 COV19");
...
CoinControlCov19Widget::~CoinControlCov19Widget()
{
    delete ui;
}
