...
#include "config/covid19-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qreal maxValue = 0;
    qint64 totalCov19 = 0;
    qint64 totalZcov19 = 0;
    QList<qreal> valuesCov19;
    QList<qreal> valueszCov19;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(COVID19GUI* _window);
    ~DashboardWidget();
