...
#include "qt/covid19/coldstakingwidget.h"
#include "qt/covid19/forms/ui_coldstakingwidget.h"
#include "qt/covid19/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/covid19/requestdialog.h"
#include "qt/covid19/tooltipmenu.h"
#include "qt/covid19/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(COVID19GUI* parent) :
    PWidget(parent),
    ...
    isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your COV19s, letting a hot node (24/7 online node)\nstake on your behalf, while you keep the keys securely offline."));
    ...
    ui->labelSubtitle2->setText(tr("Accept COV19 delegation / Delegate COV19"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select COV19 outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 COV19" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
