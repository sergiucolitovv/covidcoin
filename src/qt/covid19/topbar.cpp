...
#include "qt/covid19/topbar.h"
#include "qt/covid19/forms/ui_topbar.h"
#include <QPixmap>
#include "qt/covid19/lockunlock.h"
#include "qt/covid19/qtutils.h"
#include "qt/covid19/receivedialog.h"
...
TopBar::TopBar(COVID19GUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopCov19, ui->labelAmountTopzCov19}, "amount-small-topbar");
    setCssProperty({ui->labelAmountCov19, ui->labelAmountzCov19}, "amount-topbar");
    setCssProperty({ui->labelPendingCov19, ui->labelPendingzCov19, ui->labelImmatureCov19, ui->labelImmaturezCov19}, "amount-small-topbar");
...
void TopBar::updateBalances(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance,
    ...
    // COV19 Total
    CAmount cov19AvailableBalance = balance;
    // zCOV19 Balance
    CAmount matureZerocoinBalance = zerocoinBalance - unconfirmedZerocoinBalance - immatureZerocoinBalance;

    // Set
    QString totalCov19 = GUIUtil::formatBalance(cov19AvailableBalance, nDisplayUnit);
    QString totalzCov19 = GUIUtil::formatBalance(matureZerocoinBalance, nDisplayUnit, true);
    // Top
    ui->labelAmountTopCov19->setText(totalCov19);
    ui->labelAmountTopzCov19->setText(totalzCov19);

    // Expanded
    ui->labelAmountCov19->setText(totalCov19);
    ui->labelAmountzCov19->setText(totalzCov19);

    ui->labelPendingCov19->setText(GUIUtil::formatBalance(unconfirmedBalance, nDisplayUnit));
    ui->labelPendingzCov19->setText(GUIUtil::formatBalance(unconfirmedZerocoinBalance, nDisplayUnit, true));

    ui->labelImmatureCov19->setText(GUIUtil::formatBalance(immatureBalance, nDisplayUnit));
    ui->labelImmaturezCov19->setText(GUIUtil::formatBalance(immatureZerocoinBalance, nDisplayUnit, true));
}
