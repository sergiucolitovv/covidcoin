...
#include "qt/covid19/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/covid19/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(COVID19GUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to COVID19GUI::handleRestart()
