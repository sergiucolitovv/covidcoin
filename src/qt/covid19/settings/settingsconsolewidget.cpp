...
#include "qt/covid19/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/covid19/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(COVID19GUI* _window, QWidget *parent) :
