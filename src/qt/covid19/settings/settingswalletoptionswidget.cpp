...
#include "qt/covid19/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/covid19/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(COVID19GUI* _window, QWidget *parent) :
