...
#include "qt/covid19/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(COVID19GUI* _window, QWidget *parent) :
