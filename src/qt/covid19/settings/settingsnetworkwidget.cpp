...
#include "qt/covid19/settings/settingsnetworkwidget.h"
#include "qt/covid19/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/covid19/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(COVID19GUI* _window, QWidget *parent) :
