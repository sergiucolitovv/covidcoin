...
#include "qt/covid19/forms/ui_receivewidget.h"
...
#include "qt/covid19/addressholder.h"
...
ReceiveWidget::ReceiveWidget(COVID19GUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive COV19."));
