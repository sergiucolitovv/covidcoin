...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, COVID19GUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, COVID19GUI *gui, double posX = 3);
