...
public:
    ...
    int Covid19BadBlockTime() const { return nCovid19BadBlockTime; }
    int Covid19BadBlocknBits() const { return nCovid19BadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nCovid19BadBlockTime;
    unsigned int nCovid19BadBlocknBits;
