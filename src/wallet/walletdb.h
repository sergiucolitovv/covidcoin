...
public:
    ...
    bool WriteZCOV19Seed(const uint256& hashSeed, const std::vector<unsigned char>& seed);
    bool ReadZCOV19Seed(const uint256& hashSeed, std::vector<unsigned char>& seed);
    bool ReadZCOV19Seed_deprecated(uint256& seed);
    bool EraseZCOV19Seed();
    bool EraseZCOV19Seed_deprecated();

    bool WriteZCOV19Count(const uint32_t& nCount);
    bool ReadZCOV19Count(uint32_t& nCount);
