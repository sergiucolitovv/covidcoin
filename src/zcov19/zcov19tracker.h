...
#ifndef COVID19_ZCOV19TRACKER_H
#define COVID19_ZCOV19TRACKER_H
...
public:
    CzCOV19Tracker(std::string strWalletFile);
    ~CzCOV19Tracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzCOV19Wallet* zCOV19Wallet = NULL);
