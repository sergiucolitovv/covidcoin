...
#ifndef COVID19_ZCOV19WALLET_H
#define COVID19_ZCOV19WALLET_H
...
public:
    CzCOV19Wallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZCOV19(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZCOV19(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
