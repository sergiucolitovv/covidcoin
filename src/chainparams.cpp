...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (  1, uint256("00000f9822b4c421d6b6fc911b0c678b5920c63896699f2e2a033be7ab894532"))
    ( 99, uint256("000000175cda0cd59cdd9f9c5edf3ae422787566073c23c18e59d26cfe1d83f1"))
    (149, uint256("0000001dbf1509f80a04dc61b0ad13368bf29e9e504ed9753e227f6a79765cec"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1587474251, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nLastPOWBlock = 200;
        nCovid19BadBlockTime = 1471401614; // Skip nBit validation of Block 259201 per PR #915
        nCovid19BadBlocknBits = 0x1c056dac; // Skip nBit validation of Block 259201 per PR #915
        nModifierUpdateBlock = 615800;
        nZerocoinStartHeight = 210;
        nZerocoinStartTime = 1508214600; // October 17, 2017 4:30:00 AM
        nBlockEnforceSerialRange = 218; //Enforce serial range starting this block
        nBlockRecalculateAccumulators = 228; //Trigger a recalculation of accumulators
        nBlockFirstFraudulent = 230; //First block that bad serials emerged
        nBlockLastGoodCheckpoint = 240; //Last valid accumulator checkpoint
        nBlockEnforceInvalidUTXO = 245; //Start enforcing the invalid UTXO's
        nInvalidAmountFiltered = 0*COIN; //Amount of invalid coins filtered through exchanges, that should be considered valid
        nBlockZerocoinV2 = 255; //!> The block that zerocoin v2 becomes active - roughly Tuesday, May 8, 2018 4:00:00 AM GMT
        nBlockDoubleAccumulated = 259;
        ...
        nBlockStakeModifierlV2 = 270;
        nBIP65ActivationHeight = 276;
        // Activation height for TimeProtocolV2, Blocks V7 and newMessageSignatures
        nBlockTimeProtocolV2 = 280;
        ...
        // Blocks v7
        nBlockLastAccumulatorCheckpoint = 242;
        nBlockV7StartHeight = nBlockTimeProtocolV2;

        // Fake Serial Attack
        nFakeSerialBlockheightEnd = 288;
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zcov19 to be stakable
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nLastPOWBlock = 200;
        nCovid19BadBlockTime = 1489001494; // Skip nBit validation of Block 259201 per PR #915
        nCovid19BadBlocknBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        nMaturity = 15;
        nStakeMinDepth = 100;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "covid19-testnet.seed.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "covid19-testnet.seed2.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("warrows.dev", "testnet.dnsseed.covid19.warrows.dev"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet covid19 addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet covid19 script addresses start with '8' or '9'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 73);     // starting with 'W'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet covid19 BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet covid19 BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet covid19 BIP44 coin type is '1' (All coin's testnet default)
