...
class RawTransactionsTest(Covid19TestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid covid19 address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid covid19 address" in e.error['message'])
