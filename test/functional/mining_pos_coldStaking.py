...
from test_framework.covid19_node import Covid19TestNode
...
class COVID19_ColdStakingTest(Covid19TestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(Covid19TestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, None, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 COV19 from the pot)
