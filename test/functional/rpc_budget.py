...
class BudgetProposalTest(Covid19TestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test with invalid COVID19 address")
        assert_raises_rpc_error(-5, "Invalid COVID19 address", self.nodes[0].preparebudget,
        ...
        assert_raises_rpc_error(-8, "Invalid amount - Payment of 9.00 is less than minimum 10 COV19 allowed", self.nodes[0].preparebudget,
